...
const OrderForm = ({ isSubmitting, handleChange, values, errors, touched }) => {

	// function ShowTotalPrice() {
	// 	const i = values.order_items.reduce(
	// 		(i, values) => {return i + (values.quantity * values.price),
	// 		0}
	// 	)
	...
	const customerOptions = values.customerdata.map((value, i) => ({
		label: value.customername, value: value.customername, subLabel: value.customer_info[0].address
	})
	)
			...
			<div className="row">
						...
						<div className="col-12">
							<div className=" input-group input-group-lg form-group">
								...
								<div className="input-group-append">
									<Link to="/customer"
										className="btn btn-link  btn-lg  border-right border-top border-bottom border-left-none"
																...
																<div className="form-group col-7">
																	<div className="input-group input-group-lg" >
																		...
																		<Field
																			...
																			placeholder="0.000đ"
																			value = {values.order_items[index].price || ""}
											...
											<div className="col-12">
												<div className="row mb-5">
													<div className="col-5">
														<button
															type="button"
															className="btn btn-outline-primary btn-block d-flex align-items-center"
															onClick={() =>
																arrayHelpers.push({
																	product: "",
																	quantity: "",
														...
														>
															<span className="badge badge-primary mr-3"><MdAdd /> </span>
															Thêm sản phẩm
														</button>
													</div>
													{/********** Ghi chú ***********/}
				...
				<div className="form-group d-flex justify-content-between align-items-center col-12 bg-light mb-0 p-4 border-top">
					...
					<button
						...
						className="btn btn-primary btn-lg"><GoCheck className="mr-2" />Cập nhật Đơn</button>
				</div>
			</div>
		</Form>
